...
__device__ inline float16 FN_FP16(abs)(float16 x) { return cinn::common1::abs(x); }

__device__ inline bool FN_FP16(isnan)(float16 x) { return cinn::common1::isnan(x); }
__device__ inline bool FN_FP16(isinf)(float16 x) { return cinn::common1::isinf(x); }
__device__ inline bool FN_FP16(isfinite)(float16 x) { return cinn::common1::isfinite(x); }
...
#define EXPAND_REDUCE_FP16_MACRO(MACRO, ...) \
  ...
  MACRO(max_fp16, cinn::common1::raw_uint16_to_float16(0xfbff), float16, ##__VA_ARGS__) \
  MACRO(min_fp16, cinn::common1::raw_uint16_to_float16(0x7bff), float16, ##__VA_ARGS__)
